...
sudo sed -i '/dtparam=i2c_arm=on/a\'"$new_values" /boot/config.txt
...
sudo pip3 install RPi.GPIO adafruit-blinka influxdb adafruit-circuitpython-tsl2591 adafruit-circuitpython-ccs811 adafruit-circuitpython-bme680 adafruit-circuitpython-bme280 adafruit-circuitpython-seesaw RPLCD smbus2
...
# Add Telegraf config
sudo tee /etc/telegraf/telegraf.d/sgh.conf << EOF
# SGH project config
[[outputs.influxdb]]
